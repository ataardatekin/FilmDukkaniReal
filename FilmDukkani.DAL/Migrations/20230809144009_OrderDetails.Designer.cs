...
namespace FilmDukkani.DAL.Migrations
{
    ...
    [Migration("20230809144009_OrderDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FilmDukkani.Entity.Base.BaseUser", b =>
                {
            ...
            modelBuilder.Entity("FilmDukkani.Entity.Entity.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FilmDukkani.Entity.Entity.OrderDetailMovie", b =>
                {
                    ...
                    b.HasKey("OrderDetailId", "MovieId");

                    b.HasIndex("MovieId");

                    b.ToTable("OrderDetailMovie");
                });
            ...
            modelBuilder.Entity("FilmDukkani.Entity.Entity.Employee", b =>
                {
                    b.HasBaseType("FilmDukkani.Entity.Base.BaseUser");
            ...
            modelBuilder.Entity("FilmDukkani.Entity.Entity.Order", b =>
                {
                    b.HasOne("FilmDukkani.Entity.Entity.User", "User")
                        .WithOne("Order")
                        .HasForeignKey("FilmDukkani.Entity.Entity.Order", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FilmDukkani.Entity.Entity.OrderDetailMovie", b =>
                {
                    ...
                    b.HasOne("FilmDukkani.Entity.Entity.OrderDetail", "OrderDetail")
                        .WithMany("Movies")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FilmDukkani.Entity.Base.BaseUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FilmDukkani.Entity.Entity.Employee", b =>
                {
                    b.HasOne("FilmDukkani.Entity.Base.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("FilmDukkani.Entity.Entity.Employee", "Id")
            ...
            modelBuilder.Entity("FilmDukkani.Entity.Entity.User", b =>
                {
                    b.HasOne("FilmDukkani.Entity.Base.BaseUser", null)
                        .WithOne()
                        .HasForeignKey("FilmDukkani.Entity.Entity.User", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
